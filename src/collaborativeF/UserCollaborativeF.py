...
# - Since for this type of analysis we don't care to distinguish how the user rated the items, our new rho is defined as:
#   rho_new(k) = basel_series(k)
...
#            other two factors, so I preferred to choose something that grows with the same rate, but we can still try also
...
#   item_relevance_score = rho_new(u*) * rating(item) + (1 - rho_new(u*)) * popularity_score (Normalized between 1 and 5))
#
#
#

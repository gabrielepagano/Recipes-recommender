...
# the dataframe structure will be: i, name, contributor_id, tags, minutes (,submitted, n_steps,
...
for i in recipes_df.index:
    print("\nRecipes file creation in progress: " + str(i + 1) + "/" + str(len(recipes_df.index)))
